...
const servicesData = [
  ...
  },
  {
    ...
    description:
      "Crafting intuitive iOS and Android mobile applications built with seamless UI/UX and native performance for optimal user engagement.",
  },
  {
    id: "custom-web-app",
                        ...
                        <h3
                          className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl tracking-tight font-geomanist transition-colors duration-300 ${
                            isActive
                              ...
                              : "font-normal text-white/50 group-hover:text-white"
                          }`}
                        >
                          {service.title}
                        </h3>
